...
<body>
    ...
    <div class ="secondhead">
        <div class = "userdp"><img src = "Images/Avatar.png" width = 150px ></div>
        <br><br><br>
        <ul>
            <p id = "date"> This is Date </p>
            <li class = "username"> Hello Micheal Aspinwall</li><br>
            <li class = "usernav"><a class="an" href = "Property manager.php">Dashboard </a></li>
            <li class = "usernav"><a class="an" href = "Tenants.php">Tenants </a></li>
            <li class = "usernav"><a class="an" href = "Payments.php">Payments </a></li>
            <li class = "usernav"><a class="an" href = "#">Messages </a></li>
            <li class = "usernav"><a class="an" href = "Listing.php">Listing </a></li>
            <hr>
    </div>
